      ...
      <Toolbar sx={{ minHeight: 72, px: { xs: 1, md: 4 } }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 3 }}>
            <Button color="inherit" sx={{ fontWeight: 700, fontSize: 18, letterSpacing: 1, textTransform: 'none' }}>
              Calendar
            </Button>
            <Button color="inherit" sx={{ fontWeight: 700, fontSize: 18, letterSpacing: 1, textTransform: 'none' }}>
              Results & Standings
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          {user ? (
            <>
              <Typography sx={{ color: '#fff', fontWeight: 700, fontSize: 16, mx: 1 }}>{user.userName}</Typography>
            ...
            <>
              <Typography sx={{ color: '#fff', fontWeight: 700, fontSize: 16, mx: 1, cursor: 'pointer' }} onClick={handleLogin}>
                Login
              </Typography>
              <Typography sx={{ color: '#fff', fontWeight: 700, fontSize: 16, cursor: 'pointer' }}>|</Typography>
              <Typography sx={{ color: '#fff', fontWeight: 700, fontSize: 16, mx: 1, cursor: 'pointer' }} onClick={handleRegister}>
                Register
              </Typography>
            </>
          )}
