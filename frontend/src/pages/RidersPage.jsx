...
const RidersPage = ({ token }) => {
    ...
    const handleDelete = () => {
        ...
        deleteRider(selected.id, token)
            .then(() => { setConfirmDelete(false); setSelected(null); setRefresh(r => r + 1); })
    ...
    return (
        <div>
            ...
            <ConfirmDialog open={confirmDelete} title="Delete Rider" message="Are you sure?" onConfirm={handleDelete} onCancel={() => setConfirmDelete(false)} />
