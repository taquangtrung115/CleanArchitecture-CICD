...
export default function PermissionPage() {
    ...
    return (
        <MainCard title="Permission Management">
            ...
            <Typography variant="h6" sx={{ mb: 2 }}>Thêm Permission mới</Typography>
            <form onSubmit={handleSubmit} style={{ marginBottom: 24 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <TextField label="Function ID" name="functionId" value={form.functionId} onChange={handleChange} fullWidth required disabled={loading} />
                    </Grid>
                    <Grid item xs={12} sm={6} md={4}>
                        <TextField label="Action ID" name="actionId" value={form.actionId} onChange={handleChange} fullWidth required disabled={loading} />
                    </Grid>
                    <Grid item xs={12}>
                        <Button type="submit" variant="contained" disabled={loading}>Tạo Permission</Button>
                    </Grid>
                </Grid>
                {error && <Typography color="error" sx={{ mt: 1 }}>{error}</Typography>}
            </form>
            <Typography variant="h6" sx={{ mb: 1 }}>Danh sách Permission</Typography>
                ...
                <Table size="small">
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            <TableRow><TableCell colSpan={3}>Không có permission nào</TableCell></TableRow>
