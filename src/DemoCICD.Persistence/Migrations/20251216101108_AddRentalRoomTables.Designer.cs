...
namespace DemoCICD.Persistence.Migrations
{
    ...
    [Migration("20251216101108_AddRentalRoomTables")]
    partial class AddRentalRoomTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Chat.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Chat.ChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Chat.ChatRoomMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Identity.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Identity.Position", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Bills.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Bills.BillDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Locations.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Profiles.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Rooms.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Chat.ChatMessage", b =>
                {
                    b.HasOne("DemoCICD.Domain.Entities.Chat.ChatRoom", "Room")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Identity.ActionInFunction", b =>
                {
                    b.HasOne("DemoCICD.Domain.Entities.Identity.Action", "Action")
                    ...
                    b.HasOne("DemoCICD.Domain.Entities.Identity.Function", "Function")
                        .WithMany()
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.Identity.AppUser", b =>
                {
                    b.HasOne("DemoCICD.Domain.Entities.Identity.Position", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Bills.Bill", b =>
                {
                    b.HasOne("DemoCICD.Domain.Entities.RentalRoom.Profiles.Profile", "Profile")
                        .WithMany()
                        .HasForeignKey("ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DemoCICD.Domain.Entities.RentalRoom.Rooms.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Bills.BillDetail", b =>
                {
                    b.HasOne("DemoCICD.Domain.Entities.RentalRoom.Bills.Bill", null)
                        .WithMany("BillDetails")
                        .HasForeignKey("BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DemoCICD.Domain.Entities.RentalRoom.Bills.Bill", "Bill")
                        .WithMany()
            ...
            modelBuilder.Entity("DemoCICD.Domain.Entities.RentalRoom.Rooms.Room", b =>
                {
                    b.HasOne("DemoCICD.Domain.Entities.RentalRoom.Locations.Location", "Location")
                        .WithMany()
