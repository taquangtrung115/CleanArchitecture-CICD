...
public sealed class UpdateLocationCommandHandler : ICommandHandler<LocationCommand.UpdateLocationCommand>
{
    ...
    public async Task<Result> Handle(LocationCommand.UpdateLocationCommand request, CancellationToken cancellationToken)
    {
