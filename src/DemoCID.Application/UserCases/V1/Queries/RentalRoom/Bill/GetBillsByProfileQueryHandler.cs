...
public sealed class GetBillsByProfileQueryHandler : IQueryHandler<BillQuery.GetBillsByProfileQuery, List<BillResponse.Response>>
{
    ...
    public GetBillsByProfileQueryHandler(
    ...
    public async Task<Result<List<BillResponse.Response>>> Handle(BillQuery.GetBillsByProfileQuery request, CancellationToken cancellationToken)
    {
        var bills = await _billRepository.GetBillsByProfileAsync(request.ProfileId);
