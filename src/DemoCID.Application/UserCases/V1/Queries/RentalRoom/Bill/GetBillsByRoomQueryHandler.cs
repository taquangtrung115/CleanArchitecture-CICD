...
public sealed class GetBillsByRoomQueryHandler : IQueryHandler<BillQuery.GetBillsByRoomQuery, List<BillResponse.Response>>
{
    ...
    public GetBillsByRoomQueryHandler(
    ...
    public async Task<Result<List<BillResponse.Response>>> Handle(BillQuery.GetBillsByRoomQuery request, CancellationToken cancellationToken)
    {
        var bills = await _billRepository.GetBillsByRoomAsync(request.RoomId);
